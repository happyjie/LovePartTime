...
public class TextAdapter extends ArrayAdapter<String> {
    ...
    public TextAdapter(Context context, List<String> listData, int sId, int nId) {
        super(context, /*R.string.no_data*/0, listData);
        mContext = context;
        mListData = listData;
    ...
    public TextAdapter(Context context, String[] arrayData, int sId, int nId) {
        super(context, /*R.string.no_data*/0, arrayData);
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View layoutView;
        if (convertView == null) {
            layoutView = LayoutInflater.from(mContext).inflate(R.layout.choose_item, parent, false);
        } else {
...
//            view.setBackgroundDrawable(selectedDrawble);//设置选中的背景图片
            ...
            textView.setTextColor(parent.getResources().getColor(R.color.color63));
