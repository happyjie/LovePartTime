...
public class NewsRequestModel extends BaseRequestModel{
    ...
    public NewsRequestModel(String category) {
        ...
        this.min_behot_time = SharedPreferencesUtils.getLong(PreferenceConsts.NEWS_LAST_REQUEST_TIME + category);
        this.last_refresh_sub_entrance_interval = System.currentTimeMillis();
        this.loc_time = last_refresh_sub_entrance_interval;
        SharedPreferencesUtils.putLong(PreferenceConsts.NEWS_LAST_REQUEST_TIME + category, last_refresh_sub_entrance_interval);
    }
